...
!function(a, b) {
    ...
    return function(a, b, c) {
        ...
        c.normalizeData = function(a, b, d) {
            ...
            Array.prototype.push.apply(f.normalized.labels, c.times(Math.max(0, e - f.normalized.labels.length)).map(function() {
                return ""
            })),
        ...
        c.getDataArray = function(a, b, d) {
            function e(a) {
                ...
                if (!c.isDataHoleValue(a)) {
                    if (d) {
                        var b = {};
                        return "string" == typeof d ? b[d] = c.getNumberOrUndefined(a) : b.y = c.getNumberOrUndefined(a),
        ...
        c.getHighLow = function(a, b, d) {
            ...
            var f = {
              ...
              , h = void 0 === b.low;
            return (g || h) && e(a),
            (b.referenceValue || 0 === b.referenceValue) && (f.high = Math.max(b.referenceValue, f.high),
        ...
        c.createChartRect = function(a, b, d) {
            ...
            return e ? ("start" === b.axisX.position ? (k.y2 = j.top + g,
            k.y1 = Math.max(i - j.bottom, k.y2 + 1)) : (k.y2 = j.top,
            k.y1 = Math.max(i - j.bottom - g, k.y2 + 1)),
            "start" === b.axisY.position ? (k.x1 = j.left + f,
        ...
        c.splitIntoSegments = function(a, b, d) {
            ...
            for (var f = [], g = !0, h = 0; h < a.length; h += 2)
                void 0 === c.getMultiValue(b[h / 2].value) ? d.fillHoles || (g = !0) : (d.increasingX && h >= 2 && a[h] <= a[h - 2] && (g = !0),
                g && (f.push({
                    pathCoordinates: [],
                    valueData: []
                }),
            ...
            function(b, d) {
                for (var e = new c.Svg.Path, f = !0, g = 0; g < b.length; g += 2) {
                    var h = b[g]
                      , i = b[g + 1]
                      , j = d[g / 2];
                    void 0 !== c.getMultiValue(j.value) ? (f ? e.move(h, i, !1, j) : e.line(h, i, !1, j),
                    f = !1) : a.fillHoles || (f = !0)
                }
                return e
            }
            ...
            function d(b, e) {
                ...
                if (f.length) {
                    ...
                    h = 1; h < l - 1; h++)
                        ...
                        isFinite(m[h]) || (m[h] = 0));
                    for (i = (new c.Svg.Path).move(j[0], k[0], !1, e[0]),
                    h = 0; h < l - 1; h++)
    ...
    function(a, b, c) {
        ...
        function d(a, b, d) {
            ...
            b && (this.options = c.extend({}, d ? this.options : this.defaultOptions, b),
        ...
        function e() {
            return this.initializeTimeoutId ? a.clearTimeout(this.initializeTimeoutId) : (a.removeEventListener("resize", this.resizeListener),
    ...
    function(a, b, c) {
        ...
        function d(a, d, e, f, g) {
            a instanceof Element ? this._node = a : (this._node = b.createElementNS(c.namespaces.svg, a),
            "svg" === a && this.attr({
    ...
    function(a, b, c) {
        ...
        function e(a, b, d, e, f) {
            ...
            h.forEach(function(j, k) {
                ...
                c.isFalseyButZero(i[k]) && "" !== i[k] || ("x" === this.units.pos ? (j = this.chartRect.x1 + j,
    ...
    function(a, b, c) {
        ...
        function d(a) {
            ...
            e = void 0 === a.axisY.type ? new c.AutoScaleAxis(c.Axis.units.y,b.normalized.series,j,c.extend({}, a.axisY, {
    ...
    function(a, b, c) {
        ...
        function d(a) {
            var b, d;
            a.distributeSeries ? (b = c.normalizeData(this.data, a.reverseData, a.horizontalBars ? "x" : "y"),
            ...
            a.horizontalBars ? (j = m = void 0 === a.axisX.type ? new c.AutoScaleAxis(c.Axis.units.x,b.normalized.series,o,c.extend({}, a.axisX, {
                highLow: d,
                referenceValue: 0
            ...
            j = n = void 0 === a.axisY.type ? new c.AutoScaleAxis(c.Axis.units.y,b.normalized.series,o,c.extend({}, a.axisY, {
                highLow: d,
                referenceValue: 0
            ...
            b.raw.series.forEach(function(d, e) {
                ...
                b.normalized.series[e].forEach(function(g, k) {
                    ...
                    l instanceof c.StepAxis && (l.options.stretch || (r[l.units.pos] += f * (a.horizontalBars ? -1 : 1)),
        ...
        function e(a) {
            ...
            j.raw.series.forEach(function(e, g) {
                if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                    ...
                    r = c.polarToCartesian(n.x, n.y, t, l - (0 === g || o ? 0 : .2)),
