!function(n, e, s) {
    ...
    s(n).on("load", function() {
        ...
        s('a[data-action="collapse"]').on("click", function(e) {
            e.preventDefault(),
            s(this).closest(".card").children(".card-content").collapse("toggle"),
            s(this).closest(".card").find('[data-action="collapse"] i').toggleClass("ft-plus ft-minus")
        }),
        s('a[data-action="expand"]').on("click", function(e) {
            e.preventDefault(),
            s(this).closest(".card").find('[data-action="expand"] i').toggleClass("ft-maximize ft-minimize"),
            s(this).closest(".card").toggleClass("card-fullscreen")
        }),
        ...
        s('.card .heading-elements a[data-action="collapse"]').on("click", function() {
            ...
            0 < parseInt(n[0].style.height, 10) ? (e = n.css("height"),
            n.css("height", "").attr("data-height", e)) : n.data("height") && (e = n.data("height"),
            n.css("height", e).attr("data-height", ""))
        });
        var t = c.data("menu");
        "vertical-compact-menu" != t && "horizontal-menu" != t && ("vertical-menu-modern" == c.data("menu") ? "true" === localStorage.getItem("menuLocked") && s(".main-menu-content").find("li.active").parents("li").addClass("open") : s(".main-menu-content").find("li.active").parents("li").addClass("open")),
        "vertical-compact-menu" != t && "horizontal-menu" != t || (s(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"),
        s(".main-menu-content").find("li.active").parents("li").addClass("active")),
    ...
    s(e).on("click", ".menu-toggle, .modern-nav-toggle", function(e) {
        ...
        0 < s("#collapsed-sidebar").length && setTimeout(function() {
    ...
    s(e).on("click", ".main-menu-footer .footer-toggle", function(e) {
        return e.preventDefault(),
        s(this).find("i").toggleClass("pe-is-i-angle-down pe-is-i-angle-up"),
        s(".main-menu-footer").toggleClass("footer-close footer-open"),
        !1
    }),
    ...
    s(e).ready(function() {
        s(".step-icon").each(function() {
            ...
            s(this).appendTo(s(this).siblings("span.step")))
        })
    }),
    s(n).resize(function() {
