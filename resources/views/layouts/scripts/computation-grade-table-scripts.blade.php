<script >
    ...
    document.addEventListener('livewire:initialized', () => {
        ...
        @this.on('OpenComputationGradeModal', (event) => {
            $('#ComputationGradeModal').modal('show');
        });
        
        @this.on('CloseComputationGradeModal', (event) => {
            $('#ComputationGradeModal').modal('hide');
        });
        
        @this.on('DeleteConfirm', (ComputationGradeID) => {
        swal({
            title: 'Are you sure?',
            ...
            allowEscapeKey: false
                ...
                if (result.value) {
                    Livewire.dispatch('Deleted',ComputationGradeID),
