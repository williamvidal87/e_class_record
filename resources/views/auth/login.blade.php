                            ...
                            <div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
                                <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                    ...
                                    <div class="card-content">
                                            ...
                                            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                                ...
                                                <fieldset class="form-group position-relative has-icon-left">
                                                    <input type="email" class="form-control round" id="user-name"
                                                        placeholder="Your Email" name="email" :value="old('email')" required autofocus autocomplete="username">
                                        ...
                                        <p class="card-subtitle text-muted text-right font-small-3 mx-2 my-1"><span>Don't
