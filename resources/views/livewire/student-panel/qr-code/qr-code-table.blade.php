                            ...
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                       <div>{!! QrCode::size(340)->generate(Auth::user()->id_number) !!}</div>
                                       
                                       <div class="footer justify-content-center"><h1 class="badge badge-pill badge-info" style="font-size:36px">SCAN ME</h1></div>
                                    </div>
                                </div>
