<div>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">Instructor Classes</h3>
                </div>
            </div>
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-responsive">
                                            <table id="multi-ordering2" class="table table-striped table-bordered multi-ordering dataTable no-footer">
                                                ...
                                                <tbody>
                                                    @foreach($InstructorClassesData as $data)
                                                        <tr>
    ...
    <!-- InstructorClasses Modal -->
    <div class="modal fade text-left" id="InstructorClassesModal" tabindex="-1" role="dialog" aria-labelledby="InstructorClassesModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xl" role="document">
            <livewire:admin-panel.instructor-classes.view-instructor-classes-form />
        </div>
    </div>
...
@section('custom_script')
    @include('layouts.scripts.instructor-classes-table-scripts'); 
@endsection