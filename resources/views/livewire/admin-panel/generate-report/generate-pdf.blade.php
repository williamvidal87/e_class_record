<div>
    ...
    <div>
        ...
        <div style="text-align: left;margin-top:0.30in">
        ...
        <div style="text-align: center;margin-top:0.05in">
            <table style="width: 8in">
                ...
                <tr>
                        ...
                        <?php
                            $count_total_student_each_subject=0;
                                foreach ($ClassStudentData2 as $ClassStudentdata2) {
                                    if ($ClassStudentdata2->getMyClass->subject_id==$SubjectNamedata->id) {
                    ...
                    <?php
                    $count_student_passed=0;
                    $count_student_failed=0;
                        foreach($ClassStudentData as $index => $Data){
                            if ($SubjectNamedata->id==$Data->getMyClass->subject_id) {
                                ...
                                // echo number_format($totalGrade, 2, '.', '');
                                ...
                                // echo number_format($SumGrade, 2, '.', '');
                                if ($SumGrade>=75){
                                    // echo "P";
                                    $count_student_passed++;
                                }else{
                    ...
                    <td style="text-align: left;">
                        <?php echo $count_student_passed ?>
                    </td>
                    <td style="text-align: left;">
                        <?php 
                            if ($count_total_student_each_subject!=0&&$count_student_passed!=0) {
                                echo number_format(($count_student_passed/$count_total_student_each_subject)*100, 2, '.', ',').'%'; 
                            }
                        ?>
                    </td>
                    <td style="text-align: left;">
                        <?php echo $count_student_failed ?>
                    </td>
                    <td style="text-align: left;">
                        <?php 
                            if ($count_total_student_each_subject!=0&&$count_student_failed!=0) {
                                echo number_format(($count_student_failed/$count_total_student_each_subject)*100, 2, '.', ',').'%'; 
                            }
                        ?>
                    </td>
                </tr>
