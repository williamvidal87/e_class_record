                                        ...
                                        <div class="card-body pt-0 pb-1">
                                            ...
                                            <div class="media d-flex">
                                                <div class="align-self-center">
                                                    <h6 class="text-bold-600 mt-2"> Client: <span class="info">Xeon
                                                            Inc.</span></h6>
                                                    <h6 class="text-bold-600 mt-1"> Deadline: <span
                                                            class="blue-grey">5th June, 2018</span></h6>
                                                </div>
                                                <div class="media-body text-right mt-2">
                                                    <ul class="list-unstyled users-list">
                                                        ...
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            ...
                                                            class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle"
                                                                src="{{ asset('app-assets/images/portrait/small/avatar-s-18.png') }}"
                                                                alt="Avatar">
                                                        </li>
                                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                            ...
                                                            class="avatar avatar-sm pull-up">
                                                            <img class="media-object rounded-circle"
                                                                src="{{ asset('app-assets/images/portrait/small/avatar-s-17.png') }}"
                                                                alt="Avatar">
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-footer text-center p-1">
                                    ...
                                    <hr>
                                    <span class="text-muted"><a href="#" class="danger darken-2">Project X</a>
                                        Statistics</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card pull-up border-top-info border-top-3 rounded-0">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body p-1">
                                    <h4 class="font-large-1 text-bold-400">18.5% <i class="ft-users float-right"></i>
                                    </h4>
                                </div>
                                                    ...
                                                    <td class="text-truncate">
                                                        <ul class="list-unstyled users-list m-0">
                                                            ...
                                                            <li data-toggle="tooltip" data-popup="tooltip-custom"
                                                                ...
                                                                class="avatar avatar-sm pull-up">
                                                                <img class="media-object rounded-circle"
                                                                    src="{{ asset('app-assets/images/portrait/small/avatar-s-14.png') }}"
                                                                    alt="Avatar">
                                                            </li>
                                                        </ul>
                                                    </td>
