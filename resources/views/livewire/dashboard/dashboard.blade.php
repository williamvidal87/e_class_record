                        ...
                        <div class="card pull-up border-top-warning border-top-3 rounded-0">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body p-1">
                                    <h4 class="font-large-1 text-bold-400">{{ count($InstructorData) }}<i class="ft-user-check float-right"></i>
                                    </h4>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="card pull-up border-top-success border-top-3 rounded-0">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body p-1">
                                    <h4 class="font-large-1 text-bold-400">{{ count($CourseData) }}<i class="icon-docs float-right"></i>
                                    </h4>
                                </div>
                                <div class="card-footer p-1">
                                </div>
