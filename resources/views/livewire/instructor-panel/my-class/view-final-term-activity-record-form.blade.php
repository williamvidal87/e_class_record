<div>
    <div class="modal-content border-pink">
        <div class="modal-header bg-warning white">
            ...
            <button wire:click="CloseViewFinaltermActivityRecordForm" type="button" class="btn close" aria-label="Close">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <button wire:click="OpenScannerFinalTerm" type="button" class="btn btn-info mr-1 mb-1"><i class="ft-maximize"></i> Scan</button>
                                            </div>
                                        </div>
        ...
        <div class="modal-footer justify-content-between">
            <button wire:click="CloseViewFinaltermActivityRecordForm" type="button" class="btn grey btn-secondary"><i class="ft-x"></i> Close</button>
