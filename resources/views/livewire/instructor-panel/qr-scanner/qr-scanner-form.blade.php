                                                                                        ...
                                                                                        <div class="media">
                                                                                            <div class="media-left pr-1">
                                                                                                <span style="width: 30px;height: 30px;" class="avatar avatar-sm rounded-circle">
                                                                                                    <img style="min-width: 100%; height: 100%;" src="/storage/{{ $data->getUser->profile_photo_path ?? 'default-profile/admin-profile.png' }}" alt="avatar">
                                                                                                    <i></i>
                                                                                                </span>
                                            ...
                                            @if ($TempIdNumber)
                                                <div class="align-self-center halfway-fab text-center p-1">
                                                    <span style="width: 144px;height: 144px;" class="avatar avatar-lg avatar-online rounded-circle">
                                                        <img style="min-width: 100%;background-size: 100% 100%; height: 100%;background-image: url('../storage/{{$TempPhoto ?? 'default-profile/admin-profile.png'}}');" src="/others/checkmark.gif" alt="avatar">
                                                    </span>
                                                </div>
