                                                            ...
                                                            @foreach($ActivityData as $data)
                                                                <tr>
                                                                    ...
                                                                    <td style="min-width:318px;">
                                                                        <button wire:click="OpenViewRecordMidtermActivityRecord({{$data->id}})" type="button" class="btn btn-glow btn-bg-gradient-x-blue-green btn-sm"><i class="ft-sliders"></i> Manage Records</button>
