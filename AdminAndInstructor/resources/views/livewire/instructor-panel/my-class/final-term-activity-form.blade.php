<div>
    <div class="modal-content">
        <div class="modal-header bg-info white">
            ...
            <button wire:click="CloseFinaltermActivityForm" type="button" class="btn close" aria-label="Close">
        ...
        <div class="modal-footer justify-content-between">
            <button wire:click="CloseFinaltermActivityForm" type="button" class="btn grey btn-secondary"><i class="ft-x"></i> Close</button>
